<%@ Page Title="" Language="C#" MasterPageFile="~/user/UserMaster.Master" AutoEventWireup="true"
    CodeBehind="ResumeBuild.aspx.cs" Inherits="jobportal.user.ResumeBuild" %>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-contact contact_form">
                            ...
                            <div class="col-md-6 col-sm-12">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Name must be characters" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" 
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Mobile No. must have 10 digits" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" 
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label>Country</label>
                                    <asp:DropDownList ID="ddlCountry" runat="server" DataSourceID="SqlDataSource1" CssClass="form-control w-100" AppendDataBoundItems="true"
                              ...
                              <div class="col-md-6 col-sm-12">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    placeholder="Ex: Btech with9.2 pointer">
                                    </asp:TextBox>
                                    </div>
                                </div>      
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    placeholder="Ex: Mtech with9.2 pointer">
                                    </asp:TextBox>
                                    </div>
                                </div>      
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <asp:FileUpload ID="fuResume" runat="server" CssClass="form-control pt-2" 
                                         ToolTip=".doc, .docx, .pdf extension only"></asp:FileUpload>
                                    </div>
                                </div>          
                            ...
                            <asp:Button ID="btnUpdate" runat="server" Text="Update" 
                                    CssClass="button button-contactForm boxed-btn mr-4" 
