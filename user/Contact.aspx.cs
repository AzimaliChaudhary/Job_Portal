    ...
    public partial class Contact : System.Web.UI.Page
    {
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = @"insert into Contanct values(@Name,@Email,@Subject,@Message)";
                ...
                {
                    lblMsg.Visible = true;
                    lblMsg.Text = "Thanks for reaching you will look into your query!";
                ...
                {
                    lblMsg.Visible = true;
                    lblMsg.Text = "Cannot save record right now, plz try after somtime..!";
