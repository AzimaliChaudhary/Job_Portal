<%@ Page Title="" Language="C#" MasterPageFile="~/user/UserMaster.Master" AutoEventWireup="true" CodeBehind="AppliedJobs.aspx.cs" Inherits="jobportal.user.AppliedJobs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <div style="background-image: url('../Images/bg.jpg'); width: 100%; height: 720px;
        ...
        <div class="container-fluidS pt-4 pb-4">
            ...
            <h3 class="text-center">Your Applied Jobs</h3>
