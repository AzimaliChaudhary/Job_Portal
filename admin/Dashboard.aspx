                       ...
                       <div class="card l-bg-cherry">
                          <div class="card-statistic-3 p-4">
                               ...
                               <div class="row-align-items-center mb-2 d-flex">
                                   <div class="col-8" onclick="window.location.href='UserList.aspx';" style="cursor:pointer;">
                                       <h2 class="d-flex align-items-center mb-0 subTxt">
                  ...
                  <div class="col-xl-3 col-lg-6">
                       <div class="card l-bg-blue-dark">
                          <div class="card-statistic-3 p-4">
                               ...
                               <div class="row-align-items-center mb-2 d-flex">
                                   <div class="col-8" onclick="window.location.href='JobList.aspx';" style="cursor:pointer;">
                                       <h2 class="d-flex align-items-center mb-0 subTxt">
                  ...
                  <div class="col-xl-3 col-lg-6">
                       <div class="card l-bg-green-dark">
                          <div class="card-statistic-3 p-4">
                               ...
                               <div class="row-align-items-center mb-2 d-flex">
                                   <div class="col-8" onclick="window.location.href='ViewResume.aspx';" style="cursor:pointer;">
                                       <h2 class="d-flex align-items-center mb-0 subTxt">
                  ...
                  <div class="col-xl-3 col-lg-6">
                       <div class="card l-bg-orange-dark">
                          <div class="card-statistic-3 p-4">
                               ...
                               <div class="row-align-items-center mb-2 d-flex">
                                   <div class="col-8" onclick="window.location.href='ContactList.aspx';" style="cursor:pointer;">
                                       <h2 class="d-flex align-items-center mb-0 subTxt">
                                            <% Response.Write(Session["Contanct"]); %> 
                                       </h2>
                                   </div>
                               </div>
                          </div>
