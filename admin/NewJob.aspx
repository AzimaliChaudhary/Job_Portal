<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMaster.Master" AutoEventWireup="true"
    CodeBehind="NewJob.aspx.cs" Inherits="jobportal.admin.NewJob" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="background-image: url('../Images/bg.jpg'); width: 100%; height: 720px;
        ...
        <div class="container pt-4 pb-4">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    <label for="txtQualificatio" style="font-weight: 600">
                        Qualification/Education Required</label>
                    <asp:TextBox ID="txtQualificatio" runat="server" CssClass="form-control" placeholder="Ex: MCA,BTech,MBA"
                        required>
                    </asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtExperience" runat="server" CssClass="form-control" placeholder="Ex: 2Years, 1.5 Years"
                        required>
                    </asp:TextBox>
                </div>
            </div>
    ...
    <script>
        ...
        document.getElementById('<%= txtLastDate.ClientID %>').setAttribute('min', formattedDate);
    </script>
</div>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                ...
                <div class="col-md-6 pt-3">
                    <label for="ddlJobType" style="font-weight: 600">
                        Job Type</label>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Job Type is required"
                        ForeColor="Red" ControlToValidate="ddlJobType" InitialValue="0" Display="Dynamic"
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                ...
                <div class="col-md-6 pt-3">
                    <label for="fuCompanyLogo" style="font-weight: 600">
                        Company/Organization Logo</label>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    <label for="ddlCountry" style="font-weight: 600">
                        Country</label>
                ...
                <div class="col-md-6 pt-3">
                    <label for="txtState" style="font-weight: 600">
                        State</label>
                    <asp:TextBox ID="txtState" runat="server" CssClass="form-control" placeholder="Enter State" requiredte
                        >
                    </asp:TextBox>
                </div>
            </div>
