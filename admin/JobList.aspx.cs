...
namespace jobportal.admin
{
    public partial class JobList : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            string query = @"SELECT Row_Number() over(Order by (Select 1)) as [Sr.No], JobId, Title, NoOfPost, Qualification, Experience, LastDateToApply, CompanyName, Country, State, CreateDate 
FROM Jobs
WHERE Title LIKE @searchQuery + '%'"; 
            ...
            else
            {
                ...
                lblMsg.Text = "No records found for the given search query.";
